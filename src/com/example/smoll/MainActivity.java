...
import com.example.model.OnlinePlayMusic;
import com.example.model.StreContext;
...
public class MainActivity extends SwipeBackActivity implements View.OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Operation a = FactoryOperation.CreateOperation("+");
		a.setA(1);
		a.setB(2);
		int t = a.getRusult();
		Log.e("qxc", "result = " + t);
		String url = "http://mr3.douban.com/201505201520/d7500fad6bece2cf2ebc325bf2c034e3/view/song/small/p209521.mp4";
		StreContext context = new StreContext(new OnlinePlayMusic());
		context.initPlayer(this.getApplicationContext());
		context.open(url);
		context.play();
		//strage model
